...
#ad legende
p1<-p1+labs(title="C1",x="",y= "with ATP")
...
p2<-p2+labs(title="",x="",y = "without ATP")
...
#####pdf file############
pdf("RMSD_4plot_C1C2.pdf")
plot<-ggarrange(p1,p3,p2,p4,nrow=2,ncol=2,common.legend=TRUE, legend="right")
print(plot)
dev.off()
