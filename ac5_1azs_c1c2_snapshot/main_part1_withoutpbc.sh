...
#generated index 
gmx make_ndx -f $path_input/start.gro -o $path_output/index_part1_withoutpbc.ndx <<-EOF 
	a 1 - 3214
	a 3215 - 6536
	11 & 4
	12 & 4
	...
	EOF
#generated xtc
gmx trjconv -b 730000  -e 730001  -f $path_input/md_1500_pbcok.xtc -s $path_input/md-2.tpr -n $path_output/index_part1_withoutpbc.ndx -o $path_output/chainA_part1_withoutpbc.pdb <<-EOF
	13
	13
	q
	EOF
#gmx trjconv -sep -pbc mol -center -f $path_input/md_1500.xtc -s $path_input/md-2.tpr -n $path_output/index_part1.ndx -o $path_output/chainB_part1.xtc <<-EOF
#	14
#	14
#	q
#	EOF
