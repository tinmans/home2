...
gmx make_ndx -f $path_input/start.gro -o $path_output/index_part2_withoutpbc.ndx <<-EOF 
	...
	EOF
#generated xtc
gmx trjconv -b 750000  -e 750001  -f $path_input/md_1500_pbcok.xtc -s $path_input/md-2.tpr -n $path_output/index_part2_withoutpbc.ndx -o $path_output/chainA_part2_withoutpbc.pdb <<-EOF
	13
	13
	q
	EOF
