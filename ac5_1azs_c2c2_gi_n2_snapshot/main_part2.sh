...
#	q
#	EOF
gmx trjconv -sep -pbc mol -center -b 720000 -e 720001 -f $path_input/md_1500.xtc -s $path_input/md-2.tpr -n $path_output/index_part2.ndx -o $path_output/chainB_part2.pdb <<-EOF
	14
	14
	q
	EOF
