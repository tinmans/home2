...
path_output=/home/tamans/home2/ac5_1azs_c2c2_gi_n2_snapshot
#generated index 
gmx make_ndx -f $path_input/start.gro -o $path_output/index_part2_withoutpbc.ndx <<-EOF 
	a 1 - 3214
	a 3215 - 6536
	11 & 4
	12 & 4
	...
	EOF
#generated xtc
#gmx trjconv -sep -pbc mol -center -b 730000  -e 730001  -f $path_input/md_1500.xtc -s $path_input/md-2.tpr -n $path_output/index_part2.ndx -o $path_output/chainA_part2.xtc <<-EOF
#	13
#	13
#	q
#	EOF
gmx trjconv -b 720000 -e 720001 -f $path_input/md_1500.xtc -s $path_input/md-2.tpr -n $path_output/index_part2_withoutpbc.ndx -o $path_output/chainB_part2_withoutpbc.pdb <<-EOF
	14
	14
	q
	EOF
