...
#	q
#	EOF
gmx trjconv -sep -pbc mol -center -b 670000 -e 670001 -f $path_input/md_1500.xtc -s $path_input/md-2.tpr -n $path_output/index_part1.ndx -o $path_output/chainB_part1.pdb <<-EOF
	14
	14
	q
	EOF
