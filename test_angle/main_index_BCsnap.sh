...
#	q
#	EOF
gmx make_ndx -f $path_input/ac5_1azs_c1c2_golf/md/start.gro -o $path_output/index_ac5_1azs_c1c2golf_BC.ndx <<-EOF
	a 1 - 3215
	0&!11
	q
	EOF
gmx make_ndx -f $path_input/ac5_1azs_c2c2_gi_n2/md/start.gro -o $path_output/index_ac5_1azs_c2c2_gi_n2_AC.ndx <<-EOF
	a 3215 - 6536
	0&!11
	q
	EOF
