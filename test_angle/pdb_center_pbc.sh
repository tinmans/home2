...
#4
#EOF
gmx trjconv -pbc mol -center -f /mobi/group/AC5_Trajectories/ac5_1azs_c1c2/md/md_1500_pbcok.xtc -s /mobi/group/AC5_Trajectories/ac5_1azs_c1c2/md/md-2.tpr -o ac5_1azs_c1c2pbock_dt20_centerpbc.pdb -b 400000 -dt 20 << EOF 
4
4
EOF
...
#4
#EOF
gmx trjconv -pbc mol -center -f /mobi/group/AC5_Trajectories/ac5_1azs_c1c2_golf/md/md_1500_pbcok.xtc -s /mobi/group/AC5_Trajectories/ac5_1azs_c1c2_golf/md/md-2.tpr -o ac5_1azs_c1c2_golfpbock_dt20_centerpbc.pdb -b 400000 -dt 20 << EOF 
4
4
EOF
...
#4
#EOF
gmx trjconv -pbc mol -center -f /mobi/group/AC5_Trajectories/ac5_1cjk_c2c2_gi_n2/md/md_1500.xtc -s /mobi/group/AC5_Trajectories/ac5_1cjk_c2c2_gi_n2/md/md-2.tpr -o ac5_1cjk_c2c2_gi_n2_dt20_centerpbc.pdb -b 400000 -dt 20 << EOF 
4
4
EOF
