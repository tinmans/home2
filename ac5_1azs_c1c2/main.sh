...
path_output=/home/tamans/home2/ac5_1azs_c1c2
#generated index
...
EOF
#generated rmsd
gmx rms -s $path_output/chainA_av.pdb -f $path_output/chainA.xtc -o $path_output/rmsd_chainA.xvg -b 400000 <<-EOF
	0
	0
	q
	EOF
gmx rms -s $path_output/chainB_av.pdb -f $path_output/chainB.xtc -o $path_output/rmsd_chainB.xvg -b 400000 <<-EOF
        0
        0
        q
	EOF
